<div class="w-full p-1 md:p-4">
    <x-lf.card title="Thông tin nhân viên" class="primary">
        <style>
            .button:hover {
                color: red;
                border: none;
        ...
        <div class="w-full" style="border-bottom-width: 1px">
            <div class="w-1/2">
                ...
                <div class="button btnTwo"
                    style="width: 25%;float: left; text-align:center; padding: 10px;background-color: rgb(235, 235, 235);">
                    <button type="button"><b>Hợp đồng</b></button>
                </div>
                <div class="button btnThree"
                    style="width: 25%;float: left; text-align:center; padding: 10px;background-color: rgb(235, 235, 235);">
        ...
        <div class="w-full" style="margin-top: 20px;">
            ...
            @elseif($buttonClick == 3)
                ...
                <div>
                    <div style="width:50%">
                        <x-lf.form.input name="email1" type="email" label="Email" disabled />
                    </div>
                    <div style="width:50%">
                    ...
                    <a class="btn-success sm" href="{{ route('company.users.create', $profile_id) }}"
                        style="margin: 10px">Thêm tài
                        khoản</a>
                </div>
        ...
        <x-slot name="tools">
            <a class="btn-primary sm" href="{{ route('company.staff-infomations') }}">{!! lfIcon('list') !!}</a>
        </x-slot>
        <x-slot name="footer">
            <div class="card-footer flex justify-between">
                <label class="btn-primary flex-none" wire:click="store">Lưu lại</label>
