                            ...
                            <div style="padding: 10px">
                                ...
                                <div style="padding: 20px 0; border-bottom:1px solid #DDD">
                                        ...
                                        <div style="display: flex; width: 100%;">
                                            <div style="display: flex; padding-bottom: 10px;width: 80%;">
                                                ...
                                                <x-lf.form.input type="number"
                                                    name="option_after_mors.{{ $key }}.count_after"
                                    ...
                                    <button class="btn btn-sm btn-primary"
                                        wire:click.prevent="addOptionDayAfterMor">Thêm mới</button>
                                </div>
                                ...
                                <div style="padding: 20px 0; border-bottom:1px solid #DDD">
                                    ...
                                    @foreach ($option_before_mors as $key => $option_before_mor)
                                        <div style="display: flex; width: 100%;">
                                            <div style="display: flex;padding-bottom: 10px;width: 80%;">
                                                <a style="margin-top: 40px; font-size: 15px">Nếu</a>
                                                <x-lf.form.input
                                                    name="option_before_mors.{{ $key }}.time_before"
                                                    type="time" label="Về trước thời gian" style="width: 100%" />
                                                <a style="margin-top: 40px; font-size: 15px">Thì</a>
                                                <x-lf.form.input type="number"
                                                    name="option_before_mors.{{ $key }}.count_before"
                                                    label="Số công" style="width: 100%" onClick="this.select();"
                                                    placeholder="VD: 0.25, 0.5,..." />
                                    ...
                                    @endforeach
                                    <button class="btn btn-sm btn-primary"
                                        wire:click.prevent="addOptionDayBeforeMor">Thêm mới</button>
                                </div>
                                ...
                                <div style="padding: 20px 0;">
                                    ...
                                    @endforeach
                                    <button class="btn btn-sm btn-primary"
                                        wire:click.prevent="addOptionPenanceLate">Thêm mới</button>
                                </div>
                        ...
                        <div style="width:50%;">
                            <div style="padding: 10px">
                                ...
                                <div style="padding: 20px 0; border-bottom:1px solid #DDD">
                                    ...
                                    @foreach ($option_after_afts as $key => $option_after_aft)
                                        <div style="display: flex; width: 100%;">
                                            <div style="display: flex;padding-bottom: 10px;width: 80%;">
                                                <a style="margin-top: 40px; font-size: 15px">Nếu</a>
                                                <x-lf.form.input
                                                    name="option_after_afts.{{ $key }}.time_after"
                                                    type="time" label="Đến sau thời gian" style="width: 100%" />
                                                <a style="margin-top: 40px; font-size: 15px">Thì</a>
                                                <x-lf.form.input type="number"
                                                    name="option_after_afts.{{ $key }}.count_after"
                                                    label="Số công" style="width: 100%" onClick="this.select();"
                                                    placeholder="VD: 0.25, 0.5,..." />
                                            </div>
                                            <div>
                                    ...
                                    @endforeach
                                    <button class="btn btn-sm btn-primary"
                                        wire:click.prevent="addOptionDayAfterAft">Thêm mới</button>
                                </div>
                                ...
                                <div style="padding: 20px 0; border-bottom:1px solid #DDD">
                                    ...
                                    @foreach ($option_before_afts as $key => $option_before_aft)
                                        <div style="display: flex; width: 100%;">
                                            <div style="display: flex;padding-bottom: 10px;width: 80%;">
                                                <a style="margin-top: 40px; font-size: 15px">Nếu</a>
                                                <x-lf.form.input
                                                    name="option_before_afts.{{ $key }}.time_before"
                                                    type="time" label="Về trước thời gian" style="width: 100%" />
                                                <a style="margin-top: 40px; font-size: 15px">Thì</a>
                                                <x-lf.form.input type="number"
                                    ...
                                    @endforeach
                                    <button class="btn btn-sm btn-primary"
                                        wire:click.prevent="addOptionDayBeforeAft">Thêm mới</button>
                                </div>
                                ...
                                <div style=" padding: 20px 0">
                                        ...
                                        <div style="display: flex; width: 100%;">
                                            <div style="display: flex;padding-bottom: 10px;width: 80%;">
                                                ...
                                                <x-lf.form.input type="text"
                                                    ...
                                                    label="Tiền phạt (VNĐ)" style="width: 100%"
                                                    onClick="this.select();" placeholder="VD: 10.000" />
                                            </div>
                                            <div>
                                    ...
                                    @endforeach
                                    <button class="btn btn-sm btn-primary"
                                        wire:click.prevent="addOptionPenanceSoon">Thêm mới</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style=" border-top:1px solid #DDD; display: flex">
                            <div style="width: 50%">
                                <div style="padding: 10px;">
                                    ...
                                    @foreach ($option_after_shifts as $key => $option_after_shift)
                                        <div style="display: flex; width: 100%;">
                                            <div style="display: flex;padding-bottom: 10px;width: 80%;">
                                                <a style="margin-top: 40px; font-size: 15px">Nếu</a>
                                                <x-lf.form.input
                                                    name="option_after_shifts.{{ $key }}.time_after"
                                                    type="time" label="Chấm công sau thời gian"
                                                    style="width: 100%" />
                                                <a style="margin-top: 40px; font-size: 15px">Thì</a>
                                                <x-lf.form.input type="number"
                                    ...
                                    @endforeach
                                    <button class="btn btn-sm btn-primary"
                                        wire:click.prevent="addOptionAfterShift">Thêm
                                        mới</button>
                                </div>
                            </div>
                            <div style="width: 50%">
                                <div style="padding: 10px;">
                                    ...
                                    @foreach ($option_before_shifts as $key => $option_before_shift)
                                        <div style="display: flex; width: 100%;">
                                            <div style="display: flex;padding-bottom: 10px;width: 80%;">
                                                <a style="margin-top: 40px; font-size: 15px">Nếu</a>
                                                <x-lf.form.input
                                                    name="option_before_shifts.{{ $key }}.time_before"
                                    ...
                                    @endforeach
                                    <button class="btn btn-sm btn-primary"
                                        wire:click.prevent="addOptionBeforeShift">Thêm
                                        mới</button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @foreach ($option_penance_lates as $key => $option_penance_late)
                                        <div style="display: flex; width: 100%;">
                                            <div style="display: flex;padding-bottom: 10px;width: 80%;">
                                                ...
                                                <x-lf.form.input
                                                    name="option_penance_lates.{{ $key }}.time_penance_late"
                                                    type="number" label="Đi muộn với số phút "
                                                    style="width: 100%" />
                                                <a style="margin-top: 40px; font-size: 15px">Thì</a>
                                                <x-lf.form.input type="text"
                                                    name="option_penance_lates.{{ $key }}.monney_penance_late"
                        ...
                        <div style="padding: 10px 0; border-top:1px solid #DDD;">
                            ...
                            <div style="display: flex;">
                                <div style="width: 200px">
                                    <x-lf.form.checkbox name="selected" type="checkbox" label=""
                                        wire:model="selected" :params="['true' => 'Chọn tất cả']" />
                                </div>
                                <x-lf.form.checkbox name="day_apply" type="checkbox" label=""
                                    :params="$day" />
                            </div>
                        </div>
                    </div>
